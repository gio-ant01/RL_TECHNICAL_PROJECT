...
def generate_launch_description():
    ...
    xacro = os.path.join(get_package_share_directory('escape_room'), "urdf", "fra2mo", xacro_file_name)

    models_path = os.path.join(get_package_share_directory('escape_room'), 'models')
    world_file = os.path.join(get_package_share_directory('escape_room'), "worlds", "escape_room.sdf")
    ...
    bridge = Node(
        ...
        arguments=['/cmd_vel@geometry_msgs/msg/Twist@ignition.msgs.Twist',
                   ...
                   '/door_slide/cmd_pos@std_msgs/msg/Float64@ignition.msgs.Double'],
